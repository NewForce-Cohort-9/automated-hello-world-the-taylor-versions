    ...
    celebrities: [
      {
        id:1, 
        name: "Karen Gillan",
        details: "Karen Gillan was born and raised in Inverness, Scotland. She is recognized for projects such as playing Amy Pond, the companion to the 11th doctor, in the BBC's Doctor Who. She has starred in other memorable roles in Guardians of the Galaxy and Jumanji and many more." ,
        image: "https://fanxsaltlake.com/wp-content/uploads/sites/4/2020/06/FanX_2023_Karen-Gillan.jpg" ,
      },
      {
        id:2,
        name: "Rose Leslie",
        details: "Rose Eleanor Arbuthnot-Leslie is a Scottish actress. She is known for her roles as Gwen Dawson in the ITV drama series Downton Abbey and Ygritte in the HBO fantasy series Game of Thrones.",
        image: "https://static1.colliderimages.com/wordpress/wp-content/uploads/2022/07/294759484_472293268059688_6959451605640874517_n.jpg",
      },
      {
        id:3,
        name: "Kelly MacDonald",
        details: "Kelly MacDonald was born in Glasgow. She has received various accolades including a BAFTA Award, a Primetime Emmy Award, and four Screen Actors Guild Awards. She as staring roles in Elizabeth, Trainspotting, Harry Potter and the Deathly Hallows, and Brave.",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3ZvWwABtv4mL9RavQUOt4C6n7gINke-djw2kTmP-eag&s",
      }
      ],
    landmarks: [
      {
    ...
    cities: [
      {
        id:1,
        name: "Aberdeen",
        details: "Aberdeen is a port city in northeast Scotland, where the Dee and Don rivers meet the North Sea. With an offshore petroleum industry, the city is home to an international population. It's also known as the ‘Granite City’ for its many enduring grey-stone buildings. The 19th-century Marischal College is typical – a monumental Victorian landmark that’s now headquarters of the City Council.",
        image: "https://greatruns.com/wp-content/uploads/2019/12/Aberdeen-2-700x467.jpg",
      },
      {
        id:2,
        name: "Inverness",
        details: "Inverness is a city on Scotland’s northeast coast, where the River Ness meets the Moray Firth. It's the largest city and the cultural capital of the Scottish Highlands. Its Old Town features 19th-century Inverness Cathedral, the mostly 18th-century Old High Church and an indoor Victorian Market selling food, clothing and crafts. The contemporary Inverness Museum and Art Gallery traces local and Highland history.",
        image: "https://www.thechaoticscot.com/wp-content/uploads/2018/06/Inverness-0422-1050x700.jpg",
      },
      {
        id:3,
        name: "Edinburgh",
